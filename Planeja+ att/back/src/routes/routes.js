...
router.post('/enviarBanner/:id_usuario', Usuario.enviarArquivoBanner)
router.post('/enviarEvento/:id_usuario', Usuario.enviarArquivoEvento)
router.post('/enviarLoc/:id_usuario', Usuario.enviarArquivoLocacao)
router.post('/enviarBEvento/:id_usuario', Usuario.enviarArquivoBannerEvento)
router.post('/enviarPromotor/:id_usuario', Usuario.enviarArquivoPromotor)
...
router.get('/locacoesEvento', Locacoes.readLocacoesEventos)
router.post('/locacoesEvento/criar', Locacoes.createLocacaoEvento)
router.delete('/locacoesEvento/id/:id_locacoesEvento', Locacoes.removeEventoLocacao)
...
const Parcerias = require('../controller/parceria')
router.get('/parcerias', Parcerias.read)
router.post('/parcerias', Parcerias.create)
router.put('/parcerias/id/:id_parceria', Parcerias.update)

const Mensagens = require('../controller/messagens')
router.get('/messagens', Mensagens.read)
router.get('/messagens/idD/:destinatarioId', Mensagens.readDestinatario)
router.get('/messagens/idR/:remetenteId', Mensagens.readRemetente)
router.get('/conversa', Mensagens.readcON)
